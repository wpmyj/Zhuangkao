...
namespace zhuangkao
{
    public class CStudent
    {
        ...
        public bool SaveInfo()
        {
            ...
            string sqlstr = "insert into ready (LSH,ZKZMBH,SFZMHM,XM,KSCX,JBR,ZKKSCJ,KSRQ,KSCS,KSY1,KSY2,ZT,KS1,KS2,ISDOWN,LKYYRQ) values (@LSH,@ZKZMBH,@SFZMHM,@XM,@KSCX,@JBR,@ZKKSCJ,@KSRQ,@KSCS,@KSY1,@KSY2,@ZT,@KS1,@KS2,@ISDOWN,@LKYYRQ)";
           ...
           // System.Data.OleDb.OleDbParameter[] strParams = new System.Data.OleDb.OleDbParameter[15];
            System.Data.SqlClient.SqlParameter[] strParams = new System.Data.SqlClient.SqlParameter[paramscount];
            ...
            strParams[6].ParameterName = "@ZKKSCJ";
            ...
            strParams[15].ParameterName = "@LKYYRQ";
            object[] strValues = new object[paramscount];
            strValues[0] = _lsh;
            strValues[1] = _zkzmbh;
            strValues[2] = _sfzmbm;
            strValues[3] = _xm;
