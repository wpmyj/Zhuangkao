...
namespace zhuangkao 
{
    ...
    public class ModuleSettings
    {
        ...
        private bool _hasCheSignal;
        [DescriptionAttribute("是否使用分机。"), CategoryAttribute("车线杆属性设置")]
        public bool HasCheSignal
        {
            get { return _hasCheSignal; }
            set { _hasCheSignal = value; }
        }
        ...
        private int _state11i_time_s;
        [DescriptionAttribute("状态11i时间。"), CategoryAttribute("小车考试状态时间设置")]
        public int State11i_Time_s
        {
            set { _state11i_time_s = value; }
            get { return _state11i_time_s; }
        }
        ...
        private int _state11i_time_l;
        [DescriptionAttribute("状态11i时间。"), CategoryAttribute("大车考试状态时间设置")]
        public int State11i_Time_l
        {
            set { _state11i_time_l = value; }
            get { return _state11i_time_l; }
        }
       ...
       // [DefaultValue(20)]
        ...
        [DescriptionAttribute("是否使用声音。"), CategoryAttribute("声音")]
        ...
        private int _io378;
        [DescriptionAttribute("IO地址原0x378"), CategoryAttribute("IO地址")]
        public int IO378
        {
            get { return _io378; }
            set { _io378 = value; }
        ...
        private int _io379;
        [DescriptionAttribute("IO地址原0x379"), CategoryAttribute("IO地址")]
        public int IO379
        {
            get { return _io379; }
            set { _io379 = value; }
        ...
        private int _io37A;
        [DescriptionAttribute("IO地址原0x37A"), CategoryAttribute("IO地址")]
        public int IO37A
        {
            get { return _io37A; }
            set { _io37A = value; }
