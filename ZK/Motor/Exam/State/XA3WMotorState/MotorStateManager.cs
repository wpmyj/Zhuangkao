...
namespace Cn.Youdundianzi.Exam.State.XA3WMotorState
{
    public class MotorStateManager : StateManager, IMotorStateManager
    {
        ...
        private BaseState _z2State;
        private BaseState _zwksState;
        private BaseState _zwjsState;
        ...
        public BaseState ZWKS
        {
            get { return _zwksState; }
        }

        public BaseState ZWJS
        {
