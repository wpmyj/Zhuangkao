...
namespace Cn.Youdundianzi.Share.Module.Print
{
    ...
    { 
        ...
        public Image tiaoma
        {
            set { tiaomaimg.InImage = value; }
            get { return tiaomaimg.InImage; }
        }

        public Image TraceImg
        {
            set { traceimg.InImage = value; }
            get { return traceimg.InImage; }
        }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            ksrqtxt.PrintObj(g);
            ksyxmtxt.PrintObj(g);
            if (!(tiaomaimg.X == 0 && tiaomaimg.Y == 0))
                tiaomaimg.PrintObj(g);
            if (!(traceimg.X == 0 && traceimg.Y == 0))
                traceimg.PrintObj(g);
        }
