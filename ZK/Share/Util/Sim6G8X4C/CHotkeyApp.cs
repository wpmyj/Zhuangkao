...
namespace Cn.Youdundianzi.Share.Util.Sim6G8X4C
{
    public class CHotkeyApp
    {
        ...
        private int _che_tc;
        private int _che_xh;
        private int _xian_1, _xian_2, _xian_3, _xian_4, _xian_5, _xian_6, _xian_7, _xian_8;
        ...
        public void StartHotkey()
        {
            ...
            _che_tc = _hotkey.RegisterHotkey(System.Windows.Forms.Keys.Z, 0);
            ...
            _xian_7 = _hotkey.RegisterHotkey(System.Windows.Forms.Keys.D7, 0);
            _xian_8 = _hotkey.RegisterHotkey(System.Windows.Forms.Keys.D8, 0);
        ...
        public void hot_key(int HotKey)
        {
            ...
            if (HotKey == _che_tc)
            {
                this._receiver.ReceiveHotKey(System.Windows.Forms.Keys.Z);
                return;
            }
            if (HotKey == _che_xh)
            {
            ...
            if (HotKey == _xian_7)
            {
                this._receiver.ReceiveHotKey(System.Windows.Forms.Keys.D7);
                return;
            }
            if (HotKey == _xian_8)
            {
                this._receiver.ReceiveHotKey(System.Windows.Forms.Keys.D8);
                return;
            }
            if (HotKey == _gan_1)
            {
